"""
Django settings for anasheed project.
...
ALLOWED_HOSTS = ["127.0.0.1", ".vercel.app", "10.240.69.231"]
...
WSGI_APPLICATION = "anasheed.wsgi.application"
